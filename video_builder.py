...
async def generate_structured_script(channel_cfg: dict) -> dict:
    ...
    prompt = (
        ...
        "3. 'cta': Ajakan bertindak yang singkat, personal dan mendalam. SANGAT PENTING: Bagian CTA ini MAKSIMAL 15 KATA saja. Jangan menaruh terlalu banyak informasi di akhir! Kalimat terakhir dari cta ini HARUS dirancang sedemikian rupa agar secara tata bahasa menyambung kembali dengan mulus (seamless loop) ke kata pertama pada kalimat HOOK utama agar video bisa ditonton berulang kali secara melingkar tanpa terputus. Contoh jika HOOK = 'KENAPA KAMU MISKIN', maka akhir CTA bisa berbunyi 'dan itulah alasan utama' sehingga saat diputar ulang ia tersambung menjadi 'dan itulah alasan utama KENAPA KAMU MISKIN'. JANGAN menaruh elipsis (...) di akhir CTA, biarkan mengalir biasa.\n"
