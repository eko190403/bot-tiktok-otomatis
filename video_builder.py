...
class GeminiClientPool:
    ...
    def __init__(self, api_keys: list):
        ...
        # Instansiasi objek Client sekali saja saat startup
    ...
    for attempt in range(max_attempts):
        ...
        try:
            ...
            if any(x.lower() in err_msg.lower() for x in RETRY_ERRORS):
                # Poin 2: Penerapan Exponential Backoff adaptif untuk meredam rate limit
    ...
    for proc in psutil.process_iter(['pid', 'name']):
        try:
            if 'ffmpeg' in proc.info['name'].lower():
                # Periksa apakah subproses memegang handle ke file sementara kita
...
async def create_video() -> bool:
    ...
    try:
        ...
        # Poin 4: Pemanggilan download task dengan jaminan internal retry loop
        ...
        # Fallback asset vertikal 9:16 tervalidasi ukuran berkas > 0 byte
        if not video_files:
        ...
        # Poin 5: Konsep Smoothing/Interpolasi Teks. Daripada menghapus kata penting yang berisiko merubah arti,
        # kata dengan confidence rendah diberi modifikasi visual pudar (opacity rendah) agar integritas kalimat utuh.
        valid_words = []
        for x in all_timestamps:
            ...
            # Suntik tag visual penanda interpolasi jika nilai di bawah batas ambang ke dalam class pembangun teks
        ...
        def execute_ffmpeg_render(target_path: str):
            moviepy_resources["final_video"].write_videofile(
                target_path, fps=30, codec="libx264", preset="medium",
        ...
        # Poin 1: Perbaikan Watchdog Sejati. Jika wait_for timeout, interupsi sinyal subproses OS secara paksa
        try:
        ...
        # Poin 6: Validasi Integritas Hasil Output Video sebelum melakukan manipulasi berkas permanen
