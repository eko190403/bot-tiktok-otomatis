...
class KeywordHighlighter:
    ...
    def __init__(self):
        ...
        self._danger = re.compile(
            ...
            r"ANCAMAN|KORBAN|KEKERASAN|KRISIS|PANIK|PUTUS|HANCUR|BENCI|MARAH)\b"
        )
        ...
        self._mind = re.compile(
            ...
            r"KEPUTUSAN|IDENTITAS|KARAKTER|KEPRIBADIAN|PERILAKU)\b"
        )
        ...
        self._wealth = re.compile(
            ...
            r"JUARA|MENANG|UNGGUL|BERKEMBANG|POTENSI)\b"
        )
        ...
        self._social = re.compile(
            ...
            r"KOMUNIKASI|KONFLIK|BATAS|RESPECT|HORMATI|PEDULI|NYAMAN)\b"
        )
