...
def apply_cinematic_overlay(video_clip):
    ...
    Fungsi ini sebelumnya melakukan iterasi piksel menggunakan Numpy yang sangat lambat (OOM risk).
    Sekarang hanya mengembalikan klip mentah. Efek Cinematic Grain & Vignette 
