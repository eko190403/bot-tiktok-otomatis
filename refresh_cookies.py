...
async def main():
    print("====================================================")
    print(" TikTok Cookie Refresher (Playwright)")
    print("====================================================")
    ...
    async with async_playwright() as p:
        ...
        print(" Lakukan login seperti biasa (lewat Google, QR Code, nomor HP, dll).")
        print(" Setelah berhasil masuk ke beranda atau Creator Studio, silakan")
        ...
        # Tambahkan atribut expirationDate untuk kompatibilitas penuh dengan format lain
        for c in cookies:
